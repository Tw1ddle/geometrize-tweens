...
/**
 * Reads JSON data that maps shapes from different images to one another, and embeds it in the program at compile time
 * @author Sam Twidale (http://samcodes.co.uk/)
 */
class ShapeMappingEmbedder {
	#if macro
	...
	// Reads the given directory and embeds the files therein as static arrays of mapping data
		...
		try {
			...
			for (file in files) {
				...
				var field = {
					...
					kind: FVar(macro:Array<Int>, macro $v{values}),
